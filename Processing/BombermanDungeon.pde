...
int  tile=30, fps=120, width=960, height=540, rows=12, cols=14, margin=15, hud=75, stackIndex=0, stackCounter=0, speed=5, maxBombs=3, totBombs=0, totEnemies=1, offsetX=(49*tile), offsetY=(33*tile), topLeftR=0, topLeftC=0, cntCollision=0, CornerR=0, CornerC=0, corner=1;
